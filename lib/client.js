	...
	factory: (require) => {
		...
		function HeatmapCard(props) {
			...
			if (!hasData) body = h("div", { className: "uh-empty" }, "暂无用量数据——使用 DSH 后热力图会按天聚合本地会话日志");
				...
				body = h("div", {
					...
					ref: wrapRef
				}, h("div", { className: "uh-cal" }, h("div", { className: "uh-main" }, h("div", {
					className: "uh-months",
					style: { "--uh-cols": range.columns.length }
				}, months.map(function(mm, i) {
					return h("span", { key: i }, mm);
				})), h("div", {
				...
				body = h("div", {
					className: "uh-calWrap",
					ref: wrapRef
				}, h("div", { className: "uh-cal" }, h("div", { className: "uh-wdLabels" }, WD.map(function(w, i) {
					return h("span", { key: w }, i % 2 === 0 ? w : "");
				})), h("div", { className: "uh-main" }, h("div", {
					className: "uh-months",
					style: { "--uh-cols": range.columns.length }
				}, months.map(function(mm, i) {
					return h("span", { key: i }, mm);
		...
		function UsageHeatmapPanel() {
			...
			var kids = [h("div", {
				className: "uh-header",
				key: "header"
			}, h("div", { className: "uh-brand" }, h("strong", { className: "uh-brandName" }, "模型用量统计"), h("p", { className: "uh-brandDesc" }, "本地 DSH 会话日志聚合 · 累计 Token、活跃热力图与活动洞察")), h("div", { className: "uh-headerRight" }, h("span", { className: "uh-sum" }, headerSum), h(Btn, {
				kind: "primary",
				disabled: s.loading,
				onClick: function() {
					s.load(true);
